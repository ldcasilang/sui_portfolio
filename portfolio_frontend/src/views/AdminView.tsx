...
const AdminView = () => {
  ...
  const saveToBlockchain = async () => {
    ...
    try {
      ...
      // Fix: Cast transaction to any to resolve type conflict
      ...
      if (!portfolioObjectId && result?.effects?.created) {
        const portfolioObj = result.effects.created.find((obj: any) => 
      ...
      } else if (error.message?.includes("PackageNotFound")) {
        toast.error("❌ Contract not found. Check your Package ID.");
      } else {
